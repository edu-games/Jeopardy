...
<div class="min-h-screen flex flex-col items-center justify-center px-6 bg-gray-50">
	...
	<div class="w-full max-w-sm bg-white border border-gray-100 shadow-sm rounded-2xl p-8">
		...
		<form method="POST" class="space-y-5">
			<div>
				<label for="name" class="block text-gray-500 text-xs uppercase tracking-widest mb-2"
					>Full Name</label
				>
				<input
					type="text"
			...
			<div>
				<label for="email" class="block text-gray-500 text-xs uppercase tracking-widest mb-2"
					>Email</label
				>
				<input
					type="email"
			...
			<div>
				<label for="password" class="block text-gray-500 text-xs uppercase tracking-widest mb-2"
					>Password</label
				>
				<input
					type="password"
			...
			<div>
				<label
					for="confirmPassword"
					class="block text-gray-500 text-xs uppercase tracking-widest mb-2">Confirm Password</label
				>
				<input
					type="password"
					id="confirmPassword"
