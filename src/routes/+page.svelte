...
<div class="min-h-screen flex flex-col bg-gray-50">
    ...
    <!-- Nav -->
    <nav class="shrink-0 bg-white border-b border-gray-100 px-8 py-0 flex items-center justify-between h-14">
        <span class="text-gray-900 font-black text-sm tracking-[0.12em] uppercase">Classroom Jeopardy</span>
        <div class="flex items-center gap-3">
            ...
            {:else}
                <a href="/login" class="text-gray-500 hover:text-gray-700 text-sm font-medium transition-colors">
                    Sign In
                </a>
                <a href="/register"
                   class="px-4 py-1.5 text-sm font-bold rounded-lg transition-all hover:brightness-105"
    ...
    <div class="flex-1 flex flex-col items-center justify-center px-6 py-16">
        ...
        <div class="text-center mb-12">
            <h1 class="font-black leading-none tracking-tight mb-3"
        ...
        <div class="grid md:grid-cols-5 gap-4 w-full max-w-3xl items-start">
            ...
            <div class="md:col-span-3 rounded-2xl p-7 flex flex-col bg-white border border-gray-100 shadow-sm">
                ...
                <form onsubmit={handleJoinGame} class="flex flex-col gap-4">
                    <div>
                        <label for="gameCode" class="text-gray-400 text-[10px] uppercase tracking-widest block mb-2">Game Code</label>
                        <input
                            type="text"
                            id="gameCode"
                            bind:value={gameCode}
            ...
            <div class="md:col-span-2 rounded-2xl p-6 flex flex-col justify-between bg-white border border-gray-100 shadow-sm">
                <div>
