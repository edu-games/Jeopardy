...
<div class="max-w-4xl mx-auto">
			...
			<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
				{#each data.boards as board}
					<button
						...
						class="text-left p-4 border-2 rounded-lg transition-all {selectedBoardId === board.id
	...
	{#if selectedBoard}
		...
		<div class="bg-white rounded-lg shadow p-6 mb-6">
			...
			<div class="mb-6">
				<label class="block text-sm font-medium text-gray-700 mb-3"> Team Assignment Method </label>
				<div class="flex gap-4">
					...
					>
						...
						<div class="text-sm text-gray-600">Students automatically assigned to teams evenly</div>
					</button>
					<button
						type="button"
				...
				<div class="space-y-3">
					{#each Array.from({ length: teamCount }) as _, i}
						<div class="flex items-center gap-3">
							<div
								class="w-12 h-12 rounded-lg border-2 border-gray-300 flex items-center justify-center"
							>
								<input
									type="color"
