...
<div class="max-w-4xl">
	<div class="mb-8">
		<div class="flex items-center gap-2 mb-2">
			...
			<h1 class="font-serif-display text-4xl text-gray-900">Edit Question</h1>
		</div>
	...
	<div class="bg-white rounded-lg shadow p-6">
		...
		<form method="POST" class="space-y-6">
			<!-- Clue -->
			<div>
				<label for="clue" class="block text-sm font-medium text-gray-700 mb-2">
					Clue <span class="text-red-500">*</span>
				</label>
				<p class="text-sm text-gray-500 mb-2">This is the clue that will be shown to players</p>
				<textarea
					id="clue"
					name="clue"
					rows="3"
					required
					value={form?.clue ?? data.question.clue}
			...
			<div>
				...
				<p class="text-sm text-gray-500 mb-2">This is the correct response</p>
				<textarea
					id="response"
					name="response"
					rows="2"
					required
					value={form?.response ?? data.question.response}
					class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
					placeholder="Example: Benjamin Franklin"
				></textarea>
			</div>
