<script lang="ts">
	...
	let result = $state<{ success: boolean; message: string; count?: number } | null>(null);
...
<div class="max-w-4xl">
	<div class="mb-8">
		...
		<p class="text-gray-600">Bulk import questions from JSON format</p>
	</div>

	<!-- Instructions -->
	<div class="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
		<h2 class="text-lg font-semibold text-blue-900 mb-3">Import Format</h2>
		<p class="text-blue-800 mb-3">
			Your JSON file should have the following structure:
		</p>
		<pre class="bg-white p-4 rounded border border-blue-200 text-sm overflow-x-auto"><code>{JSON.stringify(
				{
					version: '1.0',
					questions: [
						{
							answer: 'The clue shown to players',
							question: 'The correct response (What is...?, Who is...?)',
							tags: ['Tag1', 'Tag2']
						}
					]
				},
