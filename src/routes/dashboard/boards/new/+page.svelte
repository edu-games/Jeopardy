...
<div class="max-w-7xl mx-auto">
	<div class="mb-8">
		...
		<p class="text-gray-600">Build a Jeopardy board with 6 categories and 5 questions each</p>
	</div>
			...
			<div class="overflow-y-auto max-h-[60vh] p-6">
				{#if filteredQuestions().length === 0}
					<p class="text-center text-gray-500 py-8">
						No questions found. {data.questions.length === 0 ? 'Create some questions first!' : 'Try adjusting your search.'}
					</p>
				{:else}
					<div class="space-y-3">
