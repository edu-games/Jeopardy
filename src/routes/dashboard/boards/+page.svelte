	...
	<div class="grid grid-cols-1 md:grid-cols-3 gap-4">
		...
		<div class="bg-white rounded-lg shadow p-4">
			...
			<p class="text-2xl font-bold text-gray-900">
				{data.boards.filter((b) => getBoardCompleteness(b).filled === 30).length}
			</p>
		</div>
		<div class="bg-white rounded-lg shadow p-4">
				...
				<div class="bg-white rounded-lg shadow hover:shadow-lg transition-shadow">
					<div class="p-6">
						<div class="flex justify-between items-start mb-4">
							<div class="flex-1">
								<h3 class="text-xl font-bold text-gray-900 mb-1">{board.name}</h3>
						...
						<div class="mb-3">
							<div class="flex justify-between text-sm text-gray-600 mb-1">
								...
								<span>{completeness.filled}/{completeness.total} slots filled ({completeness.percentage}%)</span>
							</div>
